...
void _mainThreadLocalDummyFunc();
void _threadLocalDummyFunc();

void _init() {
  _mainThreadLocalDummyFunc();
  _threadLocalDummyFunc();
}
...
void _mainThreadLocalDummyFunc() { static main_thread_caller_t _tmp; }
...
void _threadLocalDummyFunc() { static thread_local thread_local_caller_t _tmp; }
